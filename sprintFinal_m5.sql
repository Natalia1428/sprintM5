...
-- Indicar en qué base de dato trabajaremos
USE en_que_puedo_ayudarte;

-- Creación del usuario, contraseña y privilegios
# crea un usuario llamado “user_sprint_m5” con su clave
CREATE USER 'user_sprint_m5'@'modulo_5' IDENTIFIED BY '123';

# asignar al usuario recién creado (to 'user_sprint_m5'@'modulo_5'), 
# todos los permisos (all) 
# en todas las tablas que existan en la base de datos con nombre “en_que_puedo_ayudarte” (on en_que_puedo_ayudarte.*)
GRANT ALL ON en_que_puedo_ayudarte.* TO 'user_sprint_m5'@'modulo_5';
...
-- Instertar datos a las tablas
# 5 registros a tabla usuarios
